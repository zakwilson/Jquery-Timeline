...
f.reject=function(f,a,j){var d=[];if(null==f)return d;A(f,function(f,u,c){a.call(j,f,u,c)||(d[d.length]=f)});return d};f.every=f.all=function(a,j,d){var j=j||f.identity,c=!0;if(null==a)return c;if(o&&a.every===o)return a.every(j,d);A(a,function(f,a,u){if(!(c=c&&j.call(d,f,a,u)))return p});return c};var I=f.some=f.any=function(a,j,d){var j=j||f.identity,c=!1;if(null==a)return c;if(M&&a.some===M)return a.some(j,d);A(a,function(f,a,u){if(c=j.call(d,f,a,u))return p});return c};f.include=f.contains=function(f,
...
function(a,f){return"',"+f.replace(/\\'/g,"'")+",'"}).replace(d.evaluate||null,function(a,f){return"');"+f.replace(/\\'/g,"'").replace(/[\r\n\t]/g," ")+"__p.push('"}).replace(/\r/g,"\\r").replace(/\n/g,"\\n").replace(/\t/g,"\\t")+"');}return __p.join('');",d=new Function("obj",d);return j?d(j):d};var j=function(a){this._wrapped=a};f.prototype=j.prototype;var C=function(a,j){return j?f(a).chain():a},B=function(a,d){j.prototype[a]=function(){var a=c.call(arguments);q.call(a,this._wrapped);return C(d.apply(f,
a),this._chain)}};f.mixin(f);A("pop,push,reverse,shift,sort,splice,unshift".split(","),function(a){var f=h[a];j.prototype[a]=function(){f.apply(this._wrapped,arguments);return C(this._wrapped,this._chain)}});A(["concat","join","slice"],function(a){var f=h[a];j.prototype[a]=function(){return C(f.apply(this._wrapped,arguments),this._chain)}});j.prototype.chain=function(){this._chain=!0;return this};j.prototype.value=function(){return this._wrapped}})();(function(){var i=this,w=i.Backbone,p;p="undefined"!==typeof exports?exports:i.Backbone={};p.VERSION="0.5.1";var h=i._;if(!h&&"undefined"!==typeof require)h=require("underscore")._;var s=i.jQuery||i.Zepto;p.noConflict=function(){i.Backbone=w;return this};p.emulateHTTP=!1;p.emulateJSON=!1;p.Events={bind:function(a,d){var c=this._callbacks||(this._callbacks={});(c[a]||(c[a]=[])).push(d);return this},unbind:function(a,d){var c;if(a){if(c=this._callbacks)if(d){c=c[a];if(!c)return this;for(var e=0,i=c.length;e<
i;e++)if(d===c[e]){c[e]=null;break}}else c[a]=[]}else this._callbacks={};return this},trigger:function(a){var d,c,e,i,j=2;if(!(c=this._callbacks))return this;for(;j--;)if(d=j?a:"all",d=c[d])for(var g=0,B=d.length;g<B;g++)(e=d[g])?(i=j?Array.prototype.slice.call(arguments,1):arguments,e.apply(this,i)):(d.splice(g,1),g--,B--);return this}};p.Model=function(a,d){var c;a||(a={});if(c=this.defaults)h.isFunction(c)&&(c=c()),a=h.extend({},c,a);this.attributes={};this._escapedAttributes={};this.cid=h.uniqueId("c");
this.set(a,{silent:!0});this._changed=!1;this._previousAttributes=h.clone(this.attributes);if(d&&d.collection)this.collection=d.collection;this.initialize(a,d)};h.extend(p.Model.prototype,p.Events,{_previousAttributes:null,_changed:!1,idAttribute:"id",initialize:function(){},toJSON:function(){return h.clone(this.attributes)},get:function(a){return this.attributes[a]},escape:function(a){var d;if(d=this._escapedAttributes[a])return d;d=this.attributes[a];return this._escapedAttributes[a]=(null==d?"":
...
p.sync).call(this,"read",this,a)},save:function(a,d){d||(d={});if(a&&!this.set(a,d))return!1;var c=this,e=d.success;d.success=function(a,f,i){if(!c.set(c.parse(a,i),d))return!1;e&&e(c,a,i)};d.error=H(d.error,c,d);var i=this.isNew()?"create":"update";return(this.sync||p.sync).call(this,i,this,d)},destroy:function(a){a||(a={});if(this.isNew())return this.trigger("destroy",this,this.collection,a);var d=this,c=a.success;a.success=function(e){d.trigger("destroy",d,d.collection,a);c&&c(d,e)};a.error=H(a.error,
d,a);return(this.sync||p.sync).call(this,"delete",this,a)},url:function(){var a=z(this.collection)||this.urlRoot||D();return this.isNew()?a:a+("/"==a.charAt(a.length-1)?"":"/")+encodeURIComponent(this.id)},parse:function(a){return a},clone:function(){return new this.constructor(this)},isNew:function(){return null==this.id},change:function(a){this.trigger("change",this,a);this._previousAttributes=h.clone(this.attributes);this._changed=!1},hasChanged:function(a){return a?this._previousAttributes[a]!=
this.attributes[a]:this._changed},changedAttributes:function(a){a||(a=this.attributes);var d=this._previousAttributes,c=!1,e;for(e in a)h.isEqual(d[e],a[e])||(c=c||{},c[e]=a[e]);return c},previous:function(a){return!a||!this._previousAttributes?null:this._previousAttributes[a]},previousAttributes:function(){return h.clone(this._previousAttributes)},_performValidation:function(a,d){var c=this.validate(a);return c?(d.error?d.error(this,c,d):this.trigger("error",this,c,d),!1):!0}});p.Collection=function(a,
d){d||(d={});if(d.comparator)this.comparator=d.comparator;h.bindAll(this,"_onModelEvent","_removeReference");this._reset();a&&this.reset(a,{silent:!0});this.initialize.apply(this,arguments)};h.extend(p.Collection.prototype,p.Events,{model:p.Model,initialize:function(){},toJSON:function(){return this.map(function(a){return a.toJSON()})},add:function(a,d){if(h.isArray(a))for(var c=0,e=a.length;c<e;c++)this._add(a[c],d);else this._add(a,d);return this},remove:function(a,d){if(h.isArray(a))for(var c=
...
function(a){p.Collection.prototype[a]=function(){return h[a].apply(h,[this.models].concat(h.toArray(arguments)))}});p.Router=function(a){a||(a={});if(a.routes)this.routes=a.routes;this._bindRoutes();this.initialize.apply(this,arguments)};var c=/:([\w\d]+)/g,q=/\*([\w\d]+)/g,n=/[-[\]{}()+?.,\\^$|#\s]/g;h.extend(p.Router.prototype,p.Events,{initialize:function(){},route:function(a,d,c){p.history||(p.history=new p.History);h.isRegExp(a)||(a=this._routeToRegExp(a));p.history.route(a,h.bind(function(e){e=
this._extractParameters(a,e);c.apply(this,e);this.trigger.apply(this,["route:"+d].concat(e))},this))},navigate:function(a,d){p.history.navigate(a,d)},_bindRoutes:function(){if(this.routes){var a=[],d;for(d in this.routes)a.unshift([d,this.routes[d]]);d=0;for(var c=a.length;d<c;d++)this.route(a[d][0],a[d][1],this[a[d][1]])}},_routeToRegExp:function(a){a=a.replace(n,"\\$&").replace(c,"([^/]*)").replace(q,"(.*?)");return RegExp("^"+a+"$")},_extractParameters:function(a,d){return a.exec(d).slice(1)}});
p.History=function(){this.handlers=[];h.bindAll(this,"checkUrl")};var g=/^#*/,l=/msie [\w.]+/,a=!1;h.extend(p.History.prototype,{interval:50,getFragment:function(a,d){if(null==a)if(this._hasPushState||d){var a=window.location.pathname,c=window.location.search;c&&(a+=c);0==a.indexOf(this.options.root)&&(a=a.substr(this.options.root.length))}else a=window.location.hash;return a.replace(g,"")},start:function(d){if(a)throw Error("Backbone.history has already been started");this.options=h.extend({},{root:"/"},
...
this.id;if(this.className)a["class"]=this.className;this.el=this.make(this.tagName,a)}}});p.Model.extend=p.Collection.extend=p.Router.extend=p.View.extend=function(a,d){var c=M(this,a,d);c.extend=this.extend;return c};var K={create:"POST",update:"PUT","delete":"DELETE",read:"GET"};p.sync=function(a,d,c){var e=K[a],c=h.extend({type:e,dataType:"json",processData:!1},c);if(!c.url)c.url=z(d)||D();if(!c.data&&d&&("create"==a||"update"==a))c.contentType="application/json",c.data=JSON.stringify(d.toJSON());
if(p.emulateJSON)c.contentType="application/x-www-form-urlencoded",c.processData=!0,c.data=c.data?{model:c.data}:{};if(p.emulateHTTP&&("PUT"===e||"DELETE"===e)){if(p.emulateJSON)c.data._method=e;c.type="POST";c.beforeSend=function(a){a.setRequestHeader("X-HTTP-Method-Override",e)}}return s.ajax(c)};var o=function(){},M=function(a,d,c){var e;e=d&&d.hasOwnProperty("constructor")?d.constructor:function(){return a.apply(this,arguments)};h.extend(e,a);o.prototype=a.prototype;e.prototype=new o;d&&h.extend(e.prototype,
d);c&&h.extend(e,c);e.prototype.constructor=e;e.__super__=a.prototype;return e},z=function(a){return!a||!a.url?null:h.isFunction(a.url)?a.url():a.url},D=function(){throw Error('A "url" property or function must be specified');},H=function(a,d,c){return function(e){a?a(d,e,c):d.trigger("error",d,e,c)}}}).call(this);/*
 ...
 http://paulirish.com/
*/
window.debug=function(){function i(a){c&&(q||!h||!h.log)&&c.apply(w,a)}for(var w=this,p=Array.prototype.slice,h=w.console,s={},c,q,n=9,g=["error","warn","info","debug","log"],l="assert clear count dir dirxml exception group groupCollapsed groupEnd profile profileEnd table time timeEnd trace".split(" "),a=l.length,d=[];0<=--a;)(function(a){s[a]=function(){0!==n&&h&&h[a]&&h[a].apply(h,arguments)}})(l[a]);for(a=g.length;0<=--a;)(function(a,c){s[c]=function(){var q=p.call(arguments),l=[c].concat(q);d.push(l);
i(l);if(h&&(0<n?n>a:g.length+n<=a))h.firebug?h[c].apply(w,q):h[c]?h[c](q):h.log(q)}})(a,g[a]);s.setLevel=function(a){n="number"===typeof a?a:9};s.setCallback=function(){var a=p.call(arguments),g=d.length,h=g;c=a.shift()||null;q="boolean"===typeof a[0]?a.shift():!1;for(h-="number"===typeof a[0]?a.shift():g;h<g;)i(d[h++])};return s}();/*
...
return e}});i.fn.extend({tmpl:function(a,d,c){return i.tmpl(this[0],a,d,c)},tmplItem:function(){return i.tmplItem(this[0])},template:function(a){return i.template(a,this[0])},domManip:function(a,d,c,e){if(a[0]&&i.isArray(a[0])){for(var f=i.makeArray(arguments),g=a[0],h=g.length,r=0,q;r<h&&!(q=i.data(g[r++],"tmplItem")););q&&I&&(f[2]=function(a){i.tmpl.afterManip(this,a,c)});K.apply(this,f)}else K.apply(this,arguments);I=0;H||i.tmpl.complete(z);return this}});i.extend({tmpl:function(a,d,e,g){var h=
!g;if(h)g=f,a=i.template[a]||i.template(null,a),D={};else if(!a)return a=g.tmpl,z[g.key]=g,g.nodes=[],g.wrapped&&c(g,g.wrapped),i(p(g,null,g.tmpl(i,g)));if(!a)return[];"function"===typeof d&&(d=d.call(g||{}));e&&e.wrapped&&c(e,e.wrapped);d=i.isArray(d)?i.map(d,function(d){return d?w(e,g,a,d):null}):[w(e,g,a,d)];return h?i(p(g,null,d)):d},tmplItem:function(a){var d;for(a instanceof i&&(a=a[0]);a&&1===a.nodeType&&!(d=i.data(a,"tmplItem"))&&(a=a.parentNode););return d||f},template:function(a,d){return d?
...
d,c){var e=11===d.nodeType?i.makeArray(d.childNodes):1===d.nodeType?[d]:[];c.call(a,d);n(e);I++}})})(jQuery);/*
 ...
 Requires: 1.2.2+
*/
(function(i){function w(h){var p=h||window.event,c=[].slice.call(arguments,1),q=0,n=0,g=0,h=i.event.fix(p);h.type="mousewheel";h.wheelDelta&&(q=h.wheelDelta/120);h.detail&&(q=-h.detail/3);g=q;void 0!==p.axis&&p.axis===p.HORIZONTAL_AXIS&&(g=0,n=-1*q);void 0!==p.wheelDeltaY&&(g=p.wheelDeltaY/120);void 0!==p.wheelDeltaX&&(n=-1*p.wheelDeltaX/120);c.unshift(h,q,n,g);return i.event.handle.apply(this,c)}var p=["DOMMouseScroll","mousewheel"];i.event.special.mousewheel={setup:function(){if(this.addEventListener)for(var i=
p.length;i;)this.addEventListener(p[--i],w,!1);else this.onmousewheel=w},teardown:function(){if(this.removeEventListener)for(var i=p.length;i;)this.removeEventListener(p[--i],w,!1);else this.onmousewheel=null}};i.fn.extend({mousewheel:function(i){return i?this.bind("mousewheel",i):this.trigger("mousewheel")},unmousewheel:function(i){return this.unbind("mousewheel",i)}})})(jQuery);/*
...
!1,!1,0,null);d.target.dispatchEvent(i);q?(window.clearTimeout(n),d.target==c?(c=null,q=!1,g="click",i=document.createEvent("MouseEvent"),i.initMouseEvent(g,!0,!0,window,1,d.screenX,d.screenY,d.clientX,d.clientY,!1,!1,!1,!1,0,null),d.target.dispatchEvent(i),g="dblclick",i=document.createEvent("MouseEvent"),i.initMouseEvent(g,!0,!0,window,1,d.screenX,d.screenY,d.clientX,d.clientY,!1,!1,!1,!1,0,null),d.target.dispatchEvent(i)):(c=d.target,q=!0,n=window.setTimeout(function(){q=!1},600),p(a))):(c=d.target,
q=!0,n=window.setTimeout(function(){q=!1},600),p(a))}function s(a){var g="";if(!(1<a.touches.length)){switch(a.type){case "gesturestart":alert("gesturestart");a.preventDefault();break;case "touchstart":if(i(a.changedTouches[0].target).is("select"))return;h(a);a.preventDefault();return!1;case "touchmove":w();g="mousemove";a.preventDefault();break;case "touchend":if(d)return d=!1,a.preventDefault(),!1;w();g="mouseup";break;default:return}var a=a.changedTouches[0],l=document.createEvent("MouseEvent");
l.initMouseEvent(g,!0,!0,window,1,a.screenX,a.screenY,a.clientX,a.clientY,!1,!1,!1,!1,0,null);a.target.dispatchEvent(l);"mouseup"==g&&q&&a.target==c&&(l=document.createEvent("MouseEvent"),l.initMouseEvent("click",!0,!0,window,1,a.screenX,a.screenY,a.clientX,a.clientY,!1,!1,!1,!1,0,null),a.target.dispatchEvent(l))}}i.extend(i.support,{touch:"object"==typeof Touch});i.fn.addTouch=function(){i.support.touch&&this.each(function(a,d){d.addEventListener("touchstart",s,!1);d.addEventListener("touchmove",
s,!1);d.addEventListener("touchend",s,!1);d.addEventListener("touchcancel",s,!1)})};var c=null,q=!1,n=null,g=!1,l=null,a=null,d=!1})(jQuery);/*
...
function(a,d,v){v=i.is(v,"finite")?v:10;if(i.is(a,Y))for(var c=a.length;c--;){if(T(a[c]-d)<=v)return a[c]}else{a=+a;c=d%a;if(c<v)return d-c;if(c>a-v)return d-c+a}return d};i.setWindow=function(a){e=a;d=e.document};var oa=function(a){if(i.vml){var W=/^\s+|\s+$/g,v;try{var c=new ActiveXObject("htmlfile");c.write("<body>");c.close();v=c.body}catch(j){v=createPopup().document.body}var k=v.createTextRange();oa=p(function(a){try{v.style.color=A(a).replace(W,"");var x=k.queryCommandValue("ForeColor");return"#"+
("000000"+((x&255)<<16|x&65280|(x&16711680)>>>16)[da](16)).slice(-6)}catch(d){return"none"}})}else{var e=d.createElement("i");e.title="Rapha\u00ebl Colour Picker";e.style.display="none";d.body.appendChild(e);oa=p(function(a){e.style.color=a;return d.defaultView.getComputedStyle(e,"").getPropertyValue("color")})}return oa(a)},Na=function(){return"hsb("+[this.h,this.s,this.b]+")"},qb=function(){return"hsl("+[this.h,this.s,this.l]+")"},rb=function(){return this.hex};i.hsb2rgb=function(a,d,v,c){if(i.is(a,
...
if(1<a.h)a.h=0,a.s-=0.2,0>=a.s&&(this.getColor.start={h:0,s:1,b:a.b});return d.hex};i.getColor.reset=function(){delete this.start};i.parsePathString=p(function(a){if(!a)return null;var d={a:7,c:6,h:1,l:2,m:2,q:4,s:4,t:2,v:1,z:0},c=[];i.is(a,Y)&&i.is(a[0],Y)&&(c=pa(a));c[j]||A(a).replace(nb,function(a,x,k){var e=[],a=C.call(x);k.replace(ob,function(a,d){d&&e[F](+d)});"m"==a&&2<e[j]&&(c[F]([x].concat(e.splice(0,2))),a="l",x="m"==x?"l":"L");for(;e[j]>=d[a]&&!(c[F]([x].concat(e.splice(0,d[a]))),!d[a]););
});c[da]=i._path2string;return c});i.findDotsAtSegment=function(a,d,c,j,e,k,f,g,i){var m=1-i,h=P(m,3)*a+3*P(m,2)*i*c+3*m*i*i*e+P(i,3)*f,m=P(m,3)*d+3*P(m,2)*i*j+3*m*i*i*k+P(i,3)*g,r=a+2*i*(c-a)+i*i*(e-2*c+a),q=d+2*i*(j-d)+i*i*(k-2*j+d),y=c+2*i*(e-c)+i*i*(f-2*e+c),l=j+2*i*(k-j)+i*i*(g-2*k+j),a=(1-i)*a+i*c,d=(1-i)*d+i*j,e=(1-i)*e+i*f,k=(1-i)*k+i*g,g=90-180*B.atan((r-y)/(q-l))/V;(r>y||q<l)&&(g+=180);return{x:h,y:m,m:{x:r,y:q},n:{x:y,y:l},start:{x:a,y:d},end:{x:e,y:k},alpha:g}};var ra=p(function(a){if(!a)return{x:0,
...
d,c,j,e,k){var f=1/3,g=2/3;return[f*a+g*c,f*d+g*j,f*e+g*c,f*k+g*j,e,k]},Pa=function(a,d,c,e,f,k,g,i,h,m){var r=120*V/180,q=V/180*(+f||0),l=[],o,n=p(function(a,d,x){var c=a*B.cos(x)-d*B.sin(x),a=a*B.sin(x)+d*B.cos(x);return{x:c,y:a}});if(m)u=m[0],o=m[1],k=m[2],C=m[3];else{o=n(a,d,-q);a=o.x;d=o.y;o=n(i,h,-q);i=o.x;h=o.y;B.cos(V/180*f);B.sin(V/180*f);o=(a-i)/2;u=(d-h)/2;C=o*o/(c*c)+u*u/(e*e);1<C&&(C=B.sqrt(C),c*=C,e*=C);var C=c*c,K=e*e,C=(k==g?-1:1)*B.sqrt(T((C*K-C*u*u-K*o*o)/(C*u*u+K*o*o))),k=C*c*u/
...
m=[];i=0;for(h=l[j];i<h;i++)m[i]=i%2?n(l[i-1],l[i],q).y:n(l[i],l[i+1],q).x;return m},sa=function(a,d,c,j,e,k,f,g,i){var m=1-i;return{x:P(m,3)*a+3*P(m,2)*i*c+3*m*i*i*e+P(i,3)*f,y:P(m,3)*d+3*P(m,2)*i*j+3*m*i*i*k+P(i,3)*g}},sb=p(function(a,d,c,j,e,k,f,i){var g=e-2*c+a-(f-2*e+c),m=2*(c-a)-2*(e-c),h=a-c,r=(-m+B.sqrt(m*m-4*g*h))/2/g,g=(-m-B.sqrt(m*m-4*g*h))/2/g,q=[d,i],l=[a,f];"1e12"<T(r)&&(r=0.5);"1e12"<T(g)&&(g=0.5);0<r&&1>r&&(r=sa(a,d,c,j,e,k,f,i,r),l[F](r.x),q[F](r.y));0<g&&1>g&&(r=sa(a,d,c,j,e,k,f,
i,g),l[F](r.x),q[F](r.y));g=k-2*j+d-(i-2*k+j);m=2*(j-d)-2*(k-j);h=d-j;r=(-m+B.sqrt(m*m-4*g*h))/2/g;g=(-m-B.sqrt(m*m-4*g*h))/2/g;"1e12"<T(r)&&(r=0.5);"1e12"<T(g)&&(g=0.5);0<r&&1>r&&(r=sa(a,d,c,j,e,k,f,i,r),l[F](r.x),q[F](r.y));0<g&&1>g&&(r=sa(a,d,c,j,e,k,f,i,g),l[F](r.x),q[F](r.y));return{min:{x:O[D](0,l),y:O[D](0,q)},max:{x:u[D](0,l),y:u[D](0,q)}}}),qa=p(function(a,d){var c=ga(a),e=d&&ga(d),f={x:0,y:0,bx:0,by:0,X:0,Y:0,qx:null,qy:null},k={x:0,y:0,bx:0,by:0,X:0,Y:0,qx:null,qy:null},g=function(a,d){var x,
...
e&&e[j]||0)},m=0,r=u(c[j],e&&e[j]||0);for(;m<r;m++){c[m]=g(c[m],f);i(c,m);e&&(e[m]=g(e[m],k));e&&i(e,m);h(c,e,f,k,m);h(e,c,k,f,m);var q=c[m],l=e&&e[m],y=q[j],o=e&&l[j];f.x=q[y-2];f.y=q[y-1];f.bx=J(q[y-4])||f.x;f.by=J(q[y-3])||f.y;k.bx=e&&(J(l[o-4])||k.x);k.by=e&&(J(l[o-3])||k.y);k.x=e&&l[o-2];k.y=e&&l[o-1]}return e?[c,e]:c},null,pa),Qa=p(function(a){for(var d=[],c=0,e=a[j];c<e;c++){var f={},k=a[c].match(/^([^:]*):?([\d\.]*)/);f.color=i.getRGB(k[1]);if(f.color.error)return null;f.color=f.color.hex;
...
case "src":"image"==c.type&&g.setAttributeNS(c.paper.xlink,"href",m);break;case "stroke-width":g.style.strokeWidth=m;g.setAttribute(o,m);h["stroke-dasharray"]&&r(c,h["stroke-dasharray"]);break;case "stroke-dasharray":r(c,m);break;case "translation":m=A(m).split(q);m[0]=+m[0]||0;m[1]=+m[1]||0;l&&(l[1]+=m[0],l[2]+=m[1]);ta.call(c,m[0],m[1]);break;case "scale":m=A(m).split(q);c.scale(+m[0]||1,+m[1]||+m[0]||1,isNaN(J(m[2]))?null:+m[2],isNaN(J(m[3]))?null:+m[3]);break;case "fill":if(n=A(m).match(La)){var p=
E("pattern"),B=E("image");p.id=w();E(p,{x:0,y:0,patternUnits:"userSpaceOnUse",height:1,width:1});E(B,{x:0,y:0});B.setAttributeNS(c.paper.xlink,"href",n[1]);p.appendChild(B);m=d.createElement("img");m.style.cssText="position:absolute;left:-9999em;top-9999em";m.onload=function(){E(p,{width:this.offsetWidth,height:this.offsetHeight});E(B,{width:this.offsetWidth,height:this.offsetHeight});d.body.removeChild(this);c.paper.safari()};d.body.appendChild(m);m.src=n[1];c.paper.defs.appendChild(p);g.style.fill=
"url(#"+p.id+")";E(g,{fill:"url(#"+p.id+")"});c.pattern=p;c.pattern&&Da(c);break}n=i.getRGB(m);if(n.error)if(({circle:1,ellipse:1}[a](c.type)||"r"!=A(m).charAt())&&ha(g,m,c.paper)){h.gradient=m;h.fill="none";break}else delete e.gradient,delete h.gradient,!i.is(h.opacity,"undefined")&&i.is(e.opacity,"undefined")&&E(g,{opacity:h.opacity}),!i.is(h["fill-opacity"],"undefined")&&i.is(e["fill-opacity"],"undefined")&&E(g,{"fill-opacity":h["fill-opacity"]});n[a]("opacity")&&E(g,{"fill-opacity":1<n.opacity?
...
cy:0},sx:1,sy:1};!d.bottom&&(d.bottom=this);(this.prev=d.top)&&(d.top.next=this);d.top=this;this.next=null},N=S[l];S[l].rotate=function(a,d,c){if(this.removed)return this;if(null==a)return this._.rt.cx?[this._.rt.deg,this._.rt.cx,this._.rt.cy][y](f):this._.rt.deg;var e=this.getBBox(),a=A(a).split(q);a[j]-1&&(d=J(a[1]),c=J(a[2]));a=J(a[0]);null!=d&&!1!==d?this._.rt.deg=a:this._.rt.deg+=a;null==c&&(d=null);this._.rt.cx=d;this._.rt.cy=c;d=null==d?e.x+e.width/2:d;c=null==c?e.y+e.height/2:c;this._.rt.deg?
...
this._={tx:0,ty:0,rt:{deg:0},sx:1,sy:1};!c.bottom&&(c.bottom=this);(this.prev=c.top)&&(c.top.next=this);c.top=this;this.next=null};N=S[l];N.rotate=function(a,d,c){if(this.removed)return this;if(null==a)return this._.rt.cx?[this._.rt.deg,this._.rt.cx,this._.rt.cy][y](f):this._.rt.deg;a=A(a).split(q);a[j]-1&&(d=J(a[1]),c=J(a[2]));a=J(a[0]);null!=d?this._.rt.deg=a:this._.rt.deg+=a;null==c&&(d=null);this._.rt.cx=d;this._.rt.cy=c;this.setBox(this.attrs,d,c);this.Group.style.rotation=this._.rt.deg;return this};
...
return new aa(a)};z.setSize=cb;z.top=z.bottom=null;z.raphael=i;N.resetScale=function(){if(this.removed)return this;this._.sx=1;this._.sy=1;this.attrs.scale="1 1"};N.scale=function(a,d,c,e){if(this.removed)return this;if(null==a&&null==d)return{x:this._.sx,y:this._.sy,toString:h};d=d||a;!+d&&(d=a);var g,k,i=this.attrs;if(0!=a){var r=this.getBBox(),l=r.x+r.width/2,m=r.y+r.height/2;g=T(a/this._.sx);k=T(d/this._.sy);var c=+c||0==c?c:l,e=+e||0==e?e:m,o=0<this._.sx,q=0<this._.sy,r=~~(a/T(a)),n=~~(d/T(d)),
C=g*r,u=k*n,p=this.node.style,l=c+T(l-c)*C*(l>c==o?1:-1),m=e+T(m-e)*u*(m>e==q?1:-1),B=a*r>d*n?k:g;switch(this.type){case "rect":case "image":var K=i.width*g,z=i.height*k;this.attr({height:z,r:i.r*B,width:K,x:l-K/2,y:m-z/2});break;case "circle":case "ellipse":this.attr({rx:i.rx*g,ry:i.ry*k,r:i.r*B,cx:l,cy:m});break;case "text":this.attr({x:l,y:m});break;case "path":for(var B=Ba(i.path),M=!0,o=o?C:g,q=q?u:k,u=0,C=B[j];u<C;u++){var s=B[u],O=la.call(s[0]);if(!("M"==O&&M))if(M=!1,"A"==O)s[B[u][j]-2]*=
o,s[B[u][j]-1]*=q,s[1]*=g,s[2]*=k,s[5]=+(r+n?!!+s[5]:!+s[5]);else if("H"==O)for(var O=1,P=s[j];O<P;O++)s[O]*=o;else if("V"==O)for(O=1,P=s[j];O<P;O++)s[O]*=q;else for(O=1,P=s[j];O<P;O++)s[O]*=O%2?o:q}k=ra(B);g=l-k.x-k.width/2;k=m-k.y-k.height/2;B[0][1]+=g;B[0][2]+=k;this.attr({path:B})}this.type in{text:1,image:1}&&(1!=r||1!=n)?this.transformations?(this.transformations[2]="scale(".concat(r,",",n,")"),this.node.setAttribute("transform",this.transformations[y](f)),g=-1==r?-i.x-(K||0):i.x,k=-1==n?-i.y-
(z||0):i.y,this.attr({x:g,y:k}),i.fx=r-1,i.fy=n-1):(this.node.filterMatrix=" progid:DXImageTransform.Microsoft"+".Matrix(M11=".concat(r,", M12=0, M21=0, M22=",n,", Dx=0, Dy=0, sizingmethod='auto expand', filtertype='bilinear')"),p.filter=(this.node.filterMatrix||"")+(this.node.filterOpacity||"")):this.transformations?(this.transformations[2]="",this.node.setAttribute("transform",this.transformations[y](f)),i.fx=0,i.fy=0):(this.node.filterMatrix="",p.filter=(this.node.filterMatrix||"")+(this.node.filterOpacity||
""));i.scale=[a,d,c,e][y](f);this._.sx=a;this._.sy=d}return this};N.clone=function(){if(this.removed)return null;var a=this.attr();delete a.scale;delete a.translation;return this.paper[this.type]().attr(a)};var Ga={},ua=function(a,d,c,e,j,g,f,h,r){var m=0,l=100,o=[a,d,c,e,j,g,f,h].join(),q=Ga[o],y,n;!q&&(Ga[o]=q={data:[]});q.timer&&clearTimeout(q.timer);q.timer=setTimeout(function(){delete Ga[o]},2E3);null!=r&&(l=10*~~ua(a,d,c,e,j,g,f,h));for(var u=0;u<l+1;u++){q.data[r]>u?n=q.data[u*l]:(n=i.findDotsAtSegment(a,
d,c,e,j,g,f,h,u/l),q.data[u]=n);u&&(m+=P(P(y.x-n.x,2)+P(y.y-n.y,2),0.5));if(null!=r&&m>=r)return n;y=n}if(null==r)return m},Ha=function(a,d){return function(c,e,j){for(var c=qa(c),g,f,h,r,m="",l={},q=0,o=0,n=c.length;o<n;o++){h=c[o];if("M"==h[0])g=+h[1],f=+h[2];else{r=ua(g,f,h[1],h[2],h[3],h[4],h[5],h[6]);if(q+r>e){if(d&&!l.start){g=ua(g,f,h[1],h[2],h[3],h[4],h[5],h[6],e-q);m+=["C",g.start.x,g.start.y,g.m.x,g.m.y,g.x,g.y];if(j)return m;l.start=m;m=["M",g.x,g.y+"C",g.n.x,g.n.y,g.end.x,g.end.y,h[5],
h[6]][y]();q+=r;g=+h[5];f=+h[6];continue}if(!a&&!d)return g=ua(g,f,h[1],h[2],h[3],h[4],h[5],h[6],e-q),{x:g.x,y:g.y,alpha:g.alpha}}q+=r;g=+h[5];f=+h[6]}m+=h}l.end=m;g=a?q:d?l:i.findDotsAtSegment(g,f,h[1],h[2],h[3],h[4],h[5],h[6],1);g.alpha&&(g={x:g.x,y:g.y,alpha:g.alpha});return g}},hb=Ha(1),va=Ha(),Ia=Ha(0,1);N.getTotalLength=function(){if("path"==this.type)return this.node.getTotalLength?this.node.getTotalLength():hb(this.attrs.path)};N.getPointAtLength=function(a){return"path"!=this.type?void 0:
...
a||1==a?a:P(2,-10*a)*B.sin((a-0.075)*2*V/0.3)+1},bounce:function(a){a<1/2.75?a*=7.5625*a:a<2/2.75?(a-=1.5/2.75,a=7.5625*a*a+0.75):a<2.5/2.75?(a-=2.25/2.75,a=7.5625*a*a+0.9375):(a-=2.625/2.75,a=7.5625*a*a+0.984375);return a}};var ca=[],ib=function(){for(var d=+new Date,c=0;c<ca[j];c++){var e=ca[c];if(!e.stop&&!e.el.removed){var g=d-e.start,h=e.ms,k=e.easing,r=e.from,l=e.diff,q=e.to,m=e.t,o=e.el,e={},n;if(g<h){var g=k(g/h),u;for(u in r)if(r[a](u)){switch(ya[u]){case "along":n=g*h*l[u];q.back&&(n=q.len-
n);k=va(q[u],n);o.translate(l.sx-l.x||0,l.sy-l.y||0);l.x=k.x;l.y=k.y;o.translate(k.x-l.sx,k.y-l.sy);q.rot&&o.rotate(l.r+k.alpha,k.x,k.y);break;case U:n=+r[u]+g*h*l[u];break;case "colour":n="rgb("+[Ja(G(r[u].r+g*h*l[u].r)),Ja(G(r[u].g+g*h*l[u].g)),Ja(G(r[u].b+g*h*l[u].b))][y](",")+")";break;case "path":n=[];for(var k=0,C=r[u][j];k<C;k++){n[k]=[r[u][k][0]];for(var B=1,p=r[u][k][j];B<p;B++)n[k][B]=+r[u][k][B]+g*h*l[u][k][B];n[k]=n[k][y](f)}n=n[y](f);break;case "csv":switch(u){case "translation":n=g*
h*l[u][0]-m.x;k=g*h*l[u][1]-m.y;m.x+=n;m.y+=k;n=n+f+k;break;case "rotation":n=+r[u][0]+g*h*l[u][0];r[u][1]&&(n+=","+r[u][1]+","+r[u][2]);break;case "scale":n=[+r[u][0]+g*h*l[u][0],+r[u][1]+g*h*l[u][1],2 in q[u]?q[u][2]:"",3 in q[u]?q[u][3]:""][y](f);break;case "clip-rect":n=[];for(k=4;k--;)n[k]=+r[u][k]+g*h*l[u][k]}break;default:C=[].concat(r[u]);n=[];for(k=o.paper.customAttributes[u].length;k--;)n[k]=+C[k]+g*h*l[u][k]}e[u]=n}o.attr(e);o._run&&o._run.call(o)}else q.along&&(k=va(q.along,q.len*!q.back),
o.translate(l.sx-(l.x||0)+k.x-l.sx,l.sy-(l.y||0)+k.y-l.sy),q.rot&&o.rotate(l.r+k.alpha,k.x,k.y)),(m.x||m.y)&&o.translate(-m.x,-m.y),q.scale&&(q.scale+=""),o.attr(q),ca.splice(c--,1)}}i.svg&&o&&o.paper&&o.paper.safari();ca[j]&&setTimeout(ib)},Db=function(a,d,c,e,g){var j=c-e;d.timeouts.push(setTimeout(function(){i.is(g,"function")&&g.call(d);d.animate(a,j,a.easing)},e))},Ja=function(a){return u(O(a,255),0)},ta=function(a,d){if(null==a)return{x:this._.tx,y:this._.ty,toString:h};this._.tx+=+a;this._.ty+=
...
(r[m]-k[m])/e;break;case "colour":k[m]=i.getRGB(k[m]);n=i.getRGB(r[m]);o[m]={r:(n.r-k[m].r)/e,g:(n.g-k[m].g)/e,b:(n.b-k[m].b)/e};break;case "path":n=qa(k[m],r[m]);k[m]=n[0];y=n[1];o[m]=[];n=0;for(u=k[m][j];n<u;n++){o[m][n]=[0];for(var C=1,B=k[m][n][j];C<B;C++)o[m][n][C]=(y[n][C]-k[m][n][C])/e}break;case "csv":u=A(d[m]).split(q);y=A(k[m]).split(q);switch(m){case "translation":k[m]=[0,0];o[m]=[u[0]/e,u[1]/e];break;case "rotation":k[m]=y[1]==u[1]&&y[2]==u[2]?y:[0,u[1],u[2]];o[m]=[(u[0]-k[m][0])/e,0,
0];break;case "scale":d[m]=u;k[m]=A(k[m]).split(q);o[m]=[(u[0]-k[m][0])/e,(u[1]-k[m][1])/e,0,0];break;case "clip-rect":k[m]=A(k[m]).split(q);o[m]=[];for(n=4;n--;)o[m][n]=(u[n]-k[m][n])/e}r[m]=u;break;default:u=[].concat(d[m]);y=[].concat(k[m]);o[m]=[];for(n=h.paper.customAttributes[m][j];n--;)o[m][n]=((u[n]||0)-(y[n]||0))/e}if(l){m=i.easing_formulas[g];if(!m)if((m=A(g).match(L))&&5==m[j]){var p=m;m=function(a){return c(a,+p[1],+p[2],+p[3],+p[4],e)}}else m=function(a){return a};ca.push({start:d.start||
...
l=A(c).split(""),m=0;i.is(e,c)&&(e=this.getFont(e));if(e){for(var c=(g||16)/e.face["units-per-em"],o=e.face.bbox.split(q),g=+o[0],f=+o[1]+("baseline"==f?o[3]-o[1]+ +e.face.descent:(o[3]-o[1])/2),o=0,n=l[j];o<n;o++){var y=o&&e.glyphs[l[o-1]]||{},C=e.glyphs[l[o]],m=m+(o?(y.w||e.w)+(y.k&&y.k[l[o]]||0)+e.w*h:0);C&&C.d&&r[F](this.path(C.d).attr({fill:"#000",stroke:"none",translation:[m,0]}))}r.scale(c,c,g,f).translate(a-g,d-f)}return r};i.format=function(a,d){var c=i.is(d,Y)?[0].concat(d):arguments;a&&
i.is(a,"string")&&c[j]-1&&(a=a.replace(g,function(a,d){return null==c[++d]?"":c[d]}));return a||""};i.ninja=function(){K?e.Raphael=o:delete Raphael;return i};i.el=N;i.st=aa[l];K?e.Raphael=i:Raphael=i})();(function(){function i(a){return(a+"").replace(D,"")}function w(a,d,c){for(var e=a.length;e<d;e++)a=c?"0"+a:a+"0";return a}function p(a){return"[object Array]"===I.call(a)}function h(a,d){if(a.indexOf)return a.indexOf(d);for(var c=0,e=a.length;c<e;c++)if(a[c]===d)return c;return-1}function s(a,d,c){var e=d["-"],d=d["+"],g;switch(c){case "n -":e=" "+e,d=" "+d;case "n-":a.substr(a.length-e.length)===e?g=["-",a.substr(0,a.length-e.length)]:a.substr(a.length-d.length)===d&&(g=["+",a.substr(0,a.length-
d.length)]);break;case "- n":e+=" ",d+=" ";case "-n":0===a.indexOf(e)?g=["-",a.substr(e.length)]:0===a.indexOf(d)&&(g=["+",a.substr(d.length)]);break;case "(n)":0===a.indexOf("(")&&")"===a.substr(a.length-1)&&(g=["-",a.substr(1,a.length-2)])}return g||["",a]}function c(a,d){if(!d)return 0;for(var c,e=a.getTime(),g=0,f=d.length;g<f;g++)if(c=d[g].start,null===c||e>=c)return g;return 0}function q(a){return a.split("\u00a0").join(" ").toUpperCase()}function n(a){for(var d=[],c=0,e=a.length;c<e;c++)d[c]=
q(a[c]);return d}function g(a,d,c,e){a=a.getFullYear();!e&&d.eras&&(a-=d.eras[c].offset);return a}function l(a,d){for(var c=0,e=!1,g=0,f=a.length;g<f;g++){var h=a.charAt(g);switch(h){case "'":e?d.push("'"):c++;e=!1;break;case "\\":e&&d.push("\\");e=!e;break;default:d.push(h),e=!1}}return c}function a(a,d){var d=d||"F",c;c=a.patterns;var e=d.length;if(1===e){c=c[d];if(!c)throw"Invalid date format string '"+d+"'.";d=c}else 2===e&&"%"===d.charAt(0)&&(d=d.charAt(1));return d}function d(){return/\/|dddd|ddd|dd|d|MMMM|MMM|MM|M|yyyy|yy|y|hh|h|HH|H|mm|m|ss|s|tt|t|fff|ff|f|zzz|zz|z|gg|g/g}
function e(e,f,j){e=i(e);j=j.calendar;a:{var o=j._parseRegExp;if(o){var p=o[f];if(p){f=p;break a}}else j._parseRegExp=o={};for(var p=a(j,f).replace(/([\^\$\.\*\+\?\|\[\]\(\)\{\}])/g,"\\\\$1"),u=["^"],K=[],z=0,s=0,M=d(),D;null!==(D=M.exec(p));){var H=p.slice(z,D.index),z=M.lastIndex,s=s+l(H,u);if(s%2)u.push(D[0]);else{var H=D[0],A=H.length;switch(H){case "dddd":case "ddd":case "MMMM":case "MMM":case "gg":case "g":H="(\\D+)";break;case "tt":case "t":H="(\\D*)";break;case "yyyy":case "fff":case "ff":case "f":H=
"(\\d{"+A+"})";break;case "dd":case "d":case "MM":case "M":case "yy":case "y":case "HH":case "H":case "hh":case "h":case "mm":case "m":case "ss":case "s":H="(\\d\\d?)";break;case "zzz":H="([+-]?\\d\\d?:\\d{2})";break;case "zz":case "z":H="([+-]?\\d\\d?)";break;case "/":H="(\\"+j["/"]+")";break;default:throw"Invalid date format pattern '"+H+"'.";}H&&u.push(H);K.push(D[0])}}l(p.slice(z),u);u.push("$");p={regExp:u.join("").replace(/\s+/g,"\\s+"),groups:K};f=o[f]=p}s=RegExp(f.regExp).exec(e);if(null===
s)return null;var M=f.groups,w=e=null,F=null,I=f=null,K=u=p=o=0;D=null;z=!1;H=0;for(A=M.length;H<A;H++){var R=s[H+1];if(R){var Z=M[H],L=Z.length,G=parseInt(R,10);switch(Z){case "dd":case "d":f=G;if(1>f||31<f)return null;break;case "MMM":case "MMMM":var F=j,L=3===L,Z=F.months,J=F.monthsGenitive||F.months,$=F._upperMonths,G=F._upperMonthsGen;if(!$)F._upperMonths=$=[n(Z.names),n(Z.namesAbbr)],F._upperMonthsGen=G=[n(J.names),n(J.namesAbbr)];R=q(R);F=h(L?$[1]:$[0],R);0>F&&(F=h(L?G[1]:G[0],R));if(0>F||
11<F)return null;break;case "M":case "MM":F=G-1;if(0>F||11<F)return null;break;case "y":case "yy":case "yyyy":if(4>L){w=j;R=G;G=new Date;Z=c(G);if(100>R)L=w.twoDigitYearMax,L="string"===typeof L?(new Date).getFullYear()%100+parseInt(L,10):L,w=g(G,w,Z),R+=w-w%100,R>L&&(R-=100);w=R}else w=G;if(0>w||9999<w)return null;break;case "h":case "hh":o=G;12===o&&(o=0);if(0>o||11<o)return null;break;case "H":case "HH":o=G;if(0>o||23<o)return null;break;case "m":case "mm":p=G;if(0>p||59<p)return null;break;case "s":case "ss":u=
G;if(0>u||59<u)return null;break;case "tt":case "t":z=j.PM&&(R===j.PM[0]||R===j.PM[1]||R===j.PM[2]);if(!z&&(!j.AM||R!==j.AM[0]&&R!==j.AM[1]&&R!==j.AM[2]))return null;break;case "f":case "ff":case "fff":K=G*Math.pow(10,3-L);if(0>K||999<K)return null;break;case "ddd":case "dddd":I=R;R=3===L;G=void 0;G=j.days;L=j._upperDays;if(!L)j._upperDays=L=[n(G.names),n(G.namesAbbr),n(G.namesShort)];I=q(I);R?(G=h(L[1],I),-1===G&&(G=h(L[2],I))):G=h(L[0],I);I=G;if(0>I||6<I)return null;break;case "zzz":L=R.split(/:/);
...
null===F&&(F=0);null===f&&(f=1);if(H){if(s=H.toGregorian(w,F,f),null===s)return null}else if(s.setFullYear(w,F,f),s.getDate()!==f||null!==I&&s.getDay()!==I)return null;z&&12>o&&(o+=12);s.setHours(o,p,u,K);null!==D&&(j=s.getMinutes()-(D+s.getTimezoneOffset()),s.setHours(s.getHours()+parseInt(j/60,10),j%60));return s}function K(e,f,j){function h(a,d){var c;c=a+"";return 1<d&&c.length<d?(c=M[d-2]+c,c.substr(c.length-d,d)):c}function i(){if(H||D)return H;H=w.test(f);D=!0;return H}function o(a,d){if(Z)return Z[d];
switch(d){case 0:return a.getFullYear();case 1:return a.getMonth();case 2:return a.getDate()}}var q=j.calendar,n=q.convert;if(!f||!f.length||"i"===f){if(j&&j.name.length)if(n)j=K(e,q.patterns.F,j);else{var j=new Date(e.getTime()),p=c(e,q.eras);j.setFullYear(g(e,q,p));j=j.toLocaleString()}else j=e.toString();return j}var p=q.eras,z="s"===f,f=a(q,f),j=[],s,M=["0","00","000"],H,D,w=/([^d]|^)(d|dd)([^d]|$)/g,A=0,I=d(),Z;for(!z&&n&&(Z=n.fromGregorian(e));;){s=I.lastIndex;n=I.exec(f);s=f.slice(s,n?n.index:
f.length);A+=l(s,j);if(!n)break;if(A%2)j.push(n[0]);else switch(s=n[0],n=s.length,s){case "ddd":case "dddd":j.push((3===n?q.days.namesAbbr:q.days.names)[e.getDay()]);break;case "d":case "dd":H=!0;j.push(h(o(e,2),n));break;case "MMM":case "MMMM":s=o(e,1);j.push(q.monthsGenitive&&i()?q.monthsGenitive[3===n?"namesAbbr":"names"][s]:q.months[3===n?"namesAbbr":"names"][s]);break;case "M":case "MM":j.push(h(o(e,1)+1,n));break;case "y":case "yy":case "yyyy":s=Z?Z[0]:g(e,q,c(e,p),z);4>n&&(s%=100);j.push(h(s,
n));break;case "h":case "hh":s=e.getHours()%12;0===s&&(s=12);j.push(h(s,n));break;case "H":case "HH":j.push(h(e.getHours(),n));break;case "m":case "mm":j.push(h(e.getMinutes(),n));break;case "s":case "ss":j.push(h(e.getSeconds(),n));break;case "t":case "tt":s=12>e.getHours()?q.AM?q.AM[0]:" ":q.PM?q.PM[0]:" ";j.push(1===n?s.charAt(0):s);break;case "f":case "ff":case "fff":j.push(h(e.getMilliseconds(),3).substr(0,n));break;case "z":case "zz":s=e.getTimezoneOffset()/60;j.push((0>=s?"+":"-")+h(Math.floor(Math.abs(s)),
n));break;case "zzz":s=e.getTimezoneOffset()/60;j.push((0>=s?"+":"-")+h(Math.floor(Math.abs(s)),2)+":"+h(Math.abs(e.getTimezoneOffset()%60),2));break;case "g":case "gg":q.eras&&j.push(q.eras[c(e,p)].name);break;case "/":j.push(q["/"]);break;default:throw"Invalid date format pattern '"+s+"'.";}}return j.join("")}var o={},M={en:{}};M["default"]=M.en;o.extend=function(a){for(var d=arguments[1]||{},c=2,e=arguments.length;c<e;c++){var g=arguments[c];if(g)for(var f in g){var h=g[f];if("undefined"!==typeof h)if(a&&
("[object Object]"===I.call(h)||p(h))){var i=d[f],i=i&&("[object Object]"===I.call(i)||p(i))?i:p(h)?[]:{};d[f]=this.extend(!0,i,h)}else d[f]=h}}return d};o.findClosestCulture=function(a){var d;if(!a)return this.culture||this.cultures["default"];"[object String]"===I.call(a)&&(a=a.split(","));if(p(a)){var c,e=this.cultures,g=a,f,h=g.length,l=[];for(f=0;f<h;f++)a=i(g[f]),a=a.split(";"),c=i(a[0]),1===a.length?a=1:(a=i(a[1]),0===a.indexOf("q=")?(a=a.substr(2),a=parseFloat(a,10),a=isNaN(a)?0:a):a=1),l.push({lang:c,
...
1);h=a+"-"+d.mo+"-"+d.da+" "+e+":"+h+":00";return c[g]=h};n.getDateFromSec=function(c){if(q[c])return q[c];var h=n.getDateFromRD(c/86400);return q[c]=h};n.isLeapYear=function(c){return 0==c%400?!0:0==c%100?!1:0==c%4?!0:!1};n.getRataDie=function(c){function i(a,d){if(h[a+"-"+d])return h[a+"-"+d];for(var c=0,e=a;e<d;e++)c=n.isLeapYear(e)?c+366:c+365;return h[a+"-"+d]=c}function a(a,d){var c;switch(a){case 1:c=0;break;case 2:c=31;break;case 3:c=59;break;case 4:c=90;break;case 5:c=120;break;case 6:c=
151;break;case 7:c=181;break;case 8:c=212;break;case 9:c=243;break;case 10:c=273;break;case 11:c=304;break;case 12:c=334}2<a&&n.isLeapYear(d)&&(c+=1);return c}var d=c.ye,e=c.mo,c=c.da,q=0;if(p[d+"-"+e+"-"+c])return p[d+"-"+e+"-"+c];if(0<=d){0==d&&(d=1);var q=146097*Math.floor(d/400),o=parseInt(i(d-d%400,d)),s=parseInt(a(e,d)),q=q+o+s+c-366}else 0>d&&(q=n.getBCRataDie({ye:d,mo:e,da:c}));return p[d+"-"+e+"-"+c]=q};n.getBCRataDie=function(c){var h=c.ye,a=c.mo,c=c.da;if(s[h+"-"+a+"-"+c])return s[h+"-"+
...
g+"' id='ev_"+b.id+"' style='width:"+b.width+"px;height:"+b.height+"px;left:"+b.left+"px;opacity:"+b.opacity+";top:"+b.top+"px;font-size:"+b.fontsize+"px;'>"+d+a+l+"<div class='timeglider-event-title' style='top:"+title_adj+"px'>"+b.title+"</div></div>")}return html};var i=function(c,h){var g=h.importance,i=c.importance;return g<i?-1:g>i?1:0},c=function(i,n){var g=!1,l=h.tree,a=l[n],d=n+1,e=!1,p=2;bump_ht=w;if(void 0!=a){for(p=0;p<a.length;p++){a:{g=a[p];if(!(i.left>g.right||i.right<g.left))if(i.left>=
g.left&&i.left<=g.right||i.right>=g.left&&i.right<=g.right||i.right>=g.right&&i.left<=g.left||i.right<=g.right&&i.left>=g.left)if(i.bottom<=g.bottom&&i.bottom>=g.top||i.top<=g.bottom&&i.top>=g.top||i.top==g.bottom&&i.top==g.top){g=!0;break a}g=!1}if(!0==g){i.top-=bump_ht;i.bottom-=bump_ht;c(i,d);e=!0;break}}if(!1==e){i.top-=i.fontsize;a.push(i);p=Math.ceil(i.height/w);a=0;for(a=1;a<=p;a++)d=n+a,l[d].push(i)}}}}})(timeglider);(function(i){function w(h){function i(a,c){return function(){return c.apply(a,arguments)}}var g=new Image,l=h.id,a=g.src=h.src;g.onerror=i(g,function(){c.reportImageSize({id:h.id,src:a,error:!0})});g.onload=i(g,function(){c.reportImageSize({id:l,src:a,width:this.width,height:this.height})})}var p=i.TG_Date,h=jQuery,s={},c;i.TG_Timeline=Backbone.Model.extend({defaults:{title:"Untitled",events:[],legend:[]},_chewTimeline:function(q){c=q.mediator;s=c.options;var n={da:[],mo:[],ye:[],de:[],ce:[],thou:[],
tenthou:[],hundredthou:[],mill:[],tenmill:[],hundredmill:[],bill:[]},g=p.units;q.startSeconds=[];q.endSeconds=[];q.spans=[];q.hasImagesAbove=!1;if(!q.color)q.color="#333333";if(q.events){for(var l,a,d,e,K=q.events.length,o=0;o<K;o++){a=q.events[o];a.id?d=a.id:a.id=d="anon"+this.anonEventId++;l=a.date_display||a.date_limit||"da";a.date_display=l.toLowerCase().substr(0,2);a.startdateObj=new p(a.startdate,a.date_display);a.enddateObj=new p(a.enddate,a.date_display);a.icon=!a.icon||"none"===a.icon?"":
s.icon_folder+a.icon;a.titleWidth=i.getStringWidth(a.title);if(a.image){l=a.image_class||"layout";if("above"==a.image_class)q.hasImagesAbove=!0;a.image={id:a.id,src:a.image,display_class:l};w(a.image);c.imagesToSize++}q.startSeconds.push(a.startdateObj.sec);q.endSeconds.push(a.enddateObj.sec);a.enddateObj.sec>a.startdateObj.sec?(a.span=!0,q.spans.push({id:a.id,start:a.startdateObj.sec,end:a.enddateObj.sec})):a.span=!1;for(var M=g.length,z=0;z<M;z++)l=g[z],e=p.getTimeUnitSerial(a.startdateObj,l),void 0!==
n[l][e]?n[l][e].push(d):n[l][e]=[d];c.eventPool["ev_"+d]=a}g=h.merge(q.startSeconds,q.endSeconds);g=timeglider.getLowHigh(g);q.bounds={first:g.low,last:g.high}}if(0<q.legend.length){g=q.legend;for(a=0;a<g.length;a++);}q.display="expanded";q.dateHash=n;delete q.events;return q},initialize:function(c){this.set(this._chewTimeline(c))},validate:function(){}})})(timeglider);(function(i){var w=i.TG_Date,p="",h="",s={},c=jQuery,q={},n="",g,l;debug.trace=function(a,d){c("#"+d).text(a)};i.TG_TimelineView=function(a,d){var e=this;h=d;s=h.options;p="#"+a._id;n=a._id;this._views={PLACE:p,CONTAINER:p+" .timeglider-container",TIMELINE_MENU:p+" .timeglider-timeline-menu",TIMELINE_MENU_UL:p+" .timeglider-timeline-menu ul",TIMELINE_LIST_BT:p+" .timeglider-list-bt",SLIDER_CONTAINER:p+" .timeglider-slider-container",SLIDER:p+" .timeglider-slider",ZOOM_DISPLAY:p+" .timeglider-zoomlevel-display",
TRUCK:p+" .timeglider-truck",CENTERLINE:p+" .timeglider-centerline",TICKS:p+" .timeglider-ticks",HANDLE:p+" .timeglider-handle",FOOTER:p+" .timeglider-footer",FILTER_BT:p+" .timeglider-filter-bt",FILTER_BOX:p+" .timeglider-filter-box",TOOLS_BT:p+" .timeglider-tools-bt"};g=this._views.CONTAINER;l=this._views.TICKS;this._templates={};this._templates={test:"testola",event_modal:this.getEventModalTemplate(),event_modal_video:c.template(null,"<div class='tg-modal timeglider-ev-video-modal ui-widget-content' id='${id}_modal'><div class='close-button-remove'></div><iframe width = '100%' height='300' src='${video}'></iframe></div>"),
...
c(g).css("height",c(p).height());this.basicFontSize=s.basic_fontsize;!1==s.show_footer&&c(this._views.FOOTER).css("display","none");this.dragSpeed=0;this.dimensions=this.getWidgetDimensions();this.ticksHandleOffset=this.rightside=this.leftside=this.tickNum=0;this.timeoout_id=1;this.sliderActive=!1;this.ztop=1E3;this.filterBoxActivated=!1;this.buildSlider();this.setupFilter();c.subscribe("mediator.timelineDataLoaded",function(){c(".timeglider-loading").fadeOut(500)});c.subscribe("mediator.ticksOffsetChange",
function(){e.tickHangies();e.registerTitles();e.registerDragging()});c.subscribe("mediator.zoomLevelChange",function(){e.tickNum=0;e.leftside=0;var a=h.getZoomLevel();c(e._views.SLIDER).slider("value",e.invSliderVal(a));e.displayZoomLevel(a);e.castTicks("zoomLevelChange")});c.subscribe("mediator.ticksReadySignal",function(){!0===h.ticksReady&&e.freshTimelines()});c.subscribe("mediator.refreshSignal",function(){e.tickNum=0;e.leftside=0;e.castTicks("refreshSignal")});c.subscribe("mediator.ticksArrayChange",
function(){});c.subscribe("mediator.focusDateChange",function(){});c.subscribe("mediator.timelineListChangeSignal",function(){e.buildTimelineMenu()});c.subscribe("mediator.activeTimelinesChange",function(){c(e._views.TIMELINE_MENU_UL+" li").each(function(){var a=c(this).attr("id");-1!=c.inArray(a,h.activeTimelines)?c(this).addClass("activeTimeline"):c(this).removeClass("activeTimeline")})});c.subscribe("mediator.filterChange",function(){});this.setPanButton(c(".timeglider-pan-right"),-30);this.setPanButton(c(".timeglider-pan-left"),
30);c(this._views.TRUCK).dblclick(function(a){var d=a.pageX-e.dimensions.container.offset.left-e.dimensions.container.width/2,c=h.getZoomInfo().spp,a=h.getFocusDate().sec,d=new w(Math.floor(a+d*c)),a=new w(a);debug.trace("DBLCLICK:"+a.mo+"-"+a.ye+" DBLCLICK:"+d.mo+"-"+d.ye,"note")}).bind("mousewheel",function(a,d){var c=Math.ceil(-1*3*d),e=h.getZoomLevel();h.setZoomLevel(e+c);return!1});c(l).draggable({axis:"x",drag:function(){h.setTicksOffset(c(this).position().left)},stop:function(){e.resetTicksHandle();
e.registerDragging()}}).delegate(g+" .timeglider-timeline-event","click",function(){var a=c(this).attr("id"),d=h.eventPool[a];if(d.click_callback){var a=d.click_callback.split("."),g=a[0];if(2==a.length)window[g][a[1]](d);else window[g](d)}else e.eventModal(a)}).delegate(".timeglider-timeline-event","mouseover",function(){var a=c(this).attr("id"),a=h.eventPool[a];debug.trace("hover, title:"+a.title,"note");e.eventHover(c(this),a)}).delegate(".timeglider-timeline-event","mouseout",function(){var a=
c(this).attr("id"),a=h.eventPool[a];debug.trace("hover, title:"+a.title,"note");e.eventUnHover(c(this),a)}).delegate(".timeglider-event-collapsed","hover",function(){var a=c(this).attr("id");debug.trace("collapsed, title:"+h.eventPool[a].title,"note")});c(g).delegate(".close-button-remove","click",function(){var a=c(this).parent().attr("id");c("#"+a).remove()});c(g).delegate(".full_modal_close","click",function(){c(".full_modal").remove()});c(g).delegate(".full_modal_scrim","click",function(){c(".full_modal").remove()});
c(g).delegate(".timeglider-more-plus","click",function(){h.zoom(-1)});c(g+" .timeglider-legend-close").live("click",function(){var a=c(g+" .timeglider-legend");a.fadeOut(300,function(){a.remove()})});c(g+" .timeglider-legend-all").live("click",function(){c(g+" .timeglider-legend li").each(function(){c(this).removeClass("tg-legend-icon-selected")});h.setFilters({origin:"legend",icon:"all"})});c.tmpl(e._templates.timeline_list_modal,{}).appendTo(g);c(e._views.TIMELINE_LIST_BT).click(function(){c(e._views.TIMELINE_MENU).toggleClass("timeglider-menu-hidden").position({my:"right bottom",
...
0,e=0,g=e=0,i=0,n=0,q="",n={},g={},p={},s={},n={},p=h.getZoomInfo().unit,s=h.getZoomInfo().width,i=h.getFocusDate(),g=parseInt(this.dimensions.tick.top),i=h.addToTicksArray({type:a.type,unit:p},i),f="",A=0,q="";if("mo"==p)n=w.getMonthAdj(i,s),s=n.width,d=n.days;this.tickNum++;"init"==a.type?(n=this.tickOffsetFromDate(h.getZoomInfo(),h.getFocusDate(),s),this.leftside=e=Math.ceil(this.dimensions.container.centerx+n),this.rightside=e+s):"l"==a.type?this.leftside=e=Math.floor(this.leftside-s):"r"==a.type&&
(e=Math.floor(this.rightside),this.rightside+=s);h.getTickBySerial(i).width=s;h.getTickBySerial(i).left=e;q=this._views.PLACE+"_"+p+"_"+i+"-"+this.tickNum;n=c("<div class='timeglider-tick' id='"+q+"'><div class='timeglider-tick-label' id='label'></div></div>").appendTo(l);n.css({width:s,left:e,top:g});g=this.getTickMarksInfo({unit:p,width:s});g=d||g.tperu;e=s/g;if(5<e){for(var a=Raphael(q,s,30),I="",d=0;d<g;++d)q=d*e,I+="M"+q+" 20 L"+q+" 30","da"==p&&16<e&&(q=this.getHourLabelFromHour(A,e),f+="<div class='timeglider-tick-hour-label' style='width:"+
(e-4)+"px'>"+q+"</div>",A++);a.path(I).attr({stroke:"#333","stroke-width":1})}"da"==p&&32<e&&n.append("<div style='position:absolute;top:14px;left:0'>"+f+"</div>");p={unit:p,width:s,serial:i};s=this.getDateLabelForTick(p);n.children("#label").text(s);return p},getHourLabelFromHour:function(a,d){var c="",c=c="",c=12<a?a-12:a;0==c&&(c=12);return c+(60<d?":00":"")+(11<a?" pm":" am")},getTickMarksInfo:function(a){switch(a.unit){case "da":a=24;break;case "mo":a=30;break;case "ye":a=12;break;default:a=
...
c(g+" .tg-timeline-envelope#"+a.id+" .titleBar .tg-timeline-legend-bt").click(function(){w.legendModal(a.id)});s=$tl.children(".titleBar");e=f+(a.bounds.first-I)/r;i=f+(a.bounds.last-I)/r;s.css({top:d,left:e,width:i-e});if("expanded"==j)a.borg=p=new timeglider.TG_Org;for(e=0;e<q.length;e++)d=this.getTimelineEventsByTick({tick:q[e],timeline:a}),c.merge(y,d);for(e=0;e<a.spans.length;e++)d=a.spans[e],d.start<A&&d.end>A&&-1==c.inArray(d.id,y)&&y.unshift(d.id);d=this.compileTickEventsAsHtml(a,y,0,"sweep");
C=a.hasImagesAbove?C-56:C;if("expanded"==j)d=p.getHTML("sweep",C),a.borg=p.getBorg();"undefined"!=d&&$tl.append(d);this.registerEventImages($tl)}w.registerTitles()},appendTimelines:function(a){for(var d=h.activeTimelines,e,g="",i=0;i<d.length;i++)e=h.timelinePool[d[i]],idArr=this.getTimelineEventsByTick({tick:a,timeline:e}),g=this.compileTickEventsAsHtml(e,idArr,a.serial,"append"),"expanded"==e.display&&(g=e.borg.getHTML(a.serial,e.top)),e=c(".tg-timeline-envelope#"+e.id).append(g),this.registerEventImages(e)},
compileTickEventsAsHtml:function(a,d,c,g){var i;i=0;var n=this.dimensions.container.centerx,l=a.display,q=$tl.height();stuff="";foSec=h.startSec;spp=h.getZoomInfo().spp;zl=h.getZoomInfo().level;buffer=20;borg=a.borg;block_arg="sweep";"append"==g&&(block_arg=c);for(c=0;c<d.length;c++)if(ev=h.eventPool["ev_"+d[c]],!0===this.passesFilters(ev,zl))if(i=n+(ev.startdateObj.sec-foSec)/spp,"expanded"==l){impq=!1!==a.size_importance?this.scaleToImportance(ev.importance,zl):1;ev.width=ev.titleWidth*impq+buffer;
ev.fontsize=this.basicFontSize*impq;ev.left=i;ev.spanwidth=0;if(!0==ev.span&&(ev.spanwidth=(ev.enddateObj.sec-ev.startdateObj.sec)/spp,ev.spanwidth>ev.width))ev.width=ev.spanwidth;i=0;if(ev.image&&"layout"===ev.image.display_class)i=ev.image.height+2,ev.width=ev.image.width>ev.width?ev.image.width:ev.width;ev.height=Math.ceil(ev.fontsize)+i;ev.top=q-ev.height;borg.addBlock(ev,block_arg)}else"collapsed"==l&&(stuff+="<div id='ev_"+ev.id+"' class='timeglider-event-collapsed' style='top:"+(q-2)+"px;left:"+
...
31536E9;break;case "tenmill":g=31536E10;break;case "hundredmill":g=31536E11;break;case "bill":g=31536E12}c.spp=g/parseInt(c.width)}}(i.zoomTree);i.getStringWidth=function(a){if(a)return c("#timeglider-measure-span").html(a).width()};String.prototype.removeWhitespace=function(){return this.replace(RegExp("\\n","g"),"")}})(timeglider);(function(i){var w={},p=i.TG_Date,h={},s=jQuery;i.TimelineCollection=Backbone.Collection.extend({model:timeglider.TG_Timeline});i.TG_Mediator=function(c){this.options=h=c;this._focusDate={};this._zoomInfo={};this._zoomLevel=1;this.ticksReady=!1;this.ticksArray=[];this.startSec=0;this.activeTimelines=[];this.max_zoom=h.max_zoom;this.min_zoom=h.min_zoom;this.fixed_zoom=this.max_zoom==this.min_zoom?!0:!1;this.gesturing=!1;this.gestureStartScale=this.gestureStartZoom=0;this.filters={include:"",exclude:"",
legend:[]};this.eventPool=[];this.timelinePool={};this.imagesToSize=this.imagesSized=0;this.timelineDataLoaded=!1;this.foo="bark";this.initial_timeline_id=h.initial_timeline_id||"";this.sole_timeline_id="";if(h.max_zoom===h.min_zoom)this.fixed_zoom=h.min_zoom;w=this};i.TG_Mediator.prototype={gotoDateZoom:function(c,h){var i=!1;this.setFocusDate(new p(c));h&&(i=this.setZoomLevel(h));(!h||!1==i)&&this.refresh()},zoom:function(c){this.setZoomLevel(this.getZoomLevel()+parseInt(c))},loadTimelineData:function(c){var h=
this;c?"object"===typeof c?h.parseData(c):"#"==c.substr(0,1)?(c=[h.getTableTimelineData(c)],h.parseData(c)):s.getJSON(c,function(c){h.parseData(c)}):(this.timelineDataLoaded=!0,this.setZoomLevel(Math.floor((this.max_zoom+this.min_zoom)/2)),this.tryLoading())},getTableTimelineData:function(c){var h={},i=0,g=[],l,a,d="",e=s(c);h.id=c.substr(1);h.title=e.attr("title")||"untitled";h.description=e.attr("description")||"";h.focus_date=e.attr("focus_date")||p.getToday;h.initial_zoom=e.attr("initial_zoom")||
20;h.events=[];e.find("tr").each(function(c){var e=s(this).children(),p;0===c?g=e.map(function(){return s(this).attr("class").replace(/^.*?\btg-(\S+)\b.*?$/,"$1")}).get():(p={},e.each(function(d){l=g[d];a=s(this).text();p[l]=a}),d="ev_"+i++,p.id=d,h.events.push(p))});e.css("display","none");return h},parseData:function(c){for(var h=0,i=c.length,g={},g={},l=0;l<i;l++)g=c[l],g.mediator=this,g=(new timeglider.TG_Timeline(g)).toJSON(),0<g.id.length&&(h++,this.swallowTimeline(g));0===h?alert("ERROR loading data: Check JSON with jsonLint"):
...
getTicksOffset:function(){return this._ticksOffset},setTicksOffset:function(c){this._ticksOffset=c;s.publish("mediator.ticksOffsetChange")},getTickBySerial:function(c){for(var h=this.ticksArray,i=h.length,g=0;g<i;g++){var l=h[g];if(l.serial==c)return l}return!1},addToTicksArray:function(c,h){"init"==c.type?(c.serial=p.getTimeUnitSerial(h,c.unit),this.ticksArray=[c]):"l"==c.type?(c.serial=this.ticksArray[0].serial-1,this.ticksArray.unshift(c)):(c.serial=this.ticksArray[this.ticksArray.length-1].serial+
1,this.ticksArray.push(c));s.publish("mediator.ticksArrayChange");return c.serial},toggleTimeline:function(c){var h=this.timelinePool[c],i=s.inArray(c,this.activeTimelines);-1==i?(this.activeTimelines.push(c),this.setFocusDate(new p(h.focus_date)),this.setZoomLevel(h.initial_zoom)):this.activeTimelines.splice(i,1);this.refresh();s.publish("mediator.activeTimelinesChange")},reportImageSize:function(c){var h=w.eventPool["ev_"+c.id];c.error?(h.image={},debug.log("WHOOPS: MISSING IMAGE: "+c.src)):(h.image.width=
